package com.ecommerce.store.axon.config;

import com.ecommerce.store.axon.aggregate.StoreAggregate;
...
public class AxonConfig {
    ...
    @Bean
    public AggregateFactory<StoreAggregate> aggregateFactory(){
        return new GenericAggregateFactory<>(StoreAggregate.class);
    }
    ...
    @Bean
    public SnapshotTriggerDefinition storeSnapshotTriggerDefinition(EventStore eventStore, TransactionManager transactionManager){
    ...
    @Bean
    public Repository<StoreAggregate> storeProductAggregateRepositoryAggregateRepository(EventStore eventStore, SnapshotTriggerDefinition snapshotTriggerDefinition){
        return EventSourcingRepository
                .builder(StoreAggregate.class)
                .eventStore(eventStore)
    ...
    public void configure(EventProcessingConfigurer configurer) {
        ...
        configurer.registerSequencingPolicy("stores",
